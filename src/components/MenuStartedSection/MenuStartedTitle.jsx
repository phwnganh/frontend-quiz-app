...
const MenuStartedTitle = () => {
    return (
        <div className={"flex flex-col gap-4 md:gap-12"}>
            ...
            <h2 className={"italic text-grey-500 dark:text-blue-300 text-preset-5-medium sm:text-preset-6 leading-preset-5 sm:leading-preset-6"}>Pick a subject to get started.</h2>
        </div>
    );
};
