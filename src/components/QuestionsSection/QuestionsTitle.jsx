    ...
    return (
        <div className={"flex flex-col gap-46"}>
            <div className={"flex flex-col gap-6"}>
                <p className={"text-grey-500 italic text-preset-6 leading-preset-6"}>Question {currentQuestionNumber} of {totalQuestions}</p>
                <h2 className={"text-preset-3 text-blue-900 leading-preset-3 font-preset-3"}>{question.question}</h2>
            </div>
