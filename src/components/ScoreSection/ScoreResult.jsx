    ...
    return (
        <div className={"flex flex-col gap-10 p-12 rounded-3xl bg-white dark:bg-blue-850 justify-center items-center"}>
            <div className={"flex items-center gap-4 sm:gap-6"}>
                ...
                <h2 className={"text-preset-4-mobile sm:text-preset-4 leading-preset-4 font-preset-4 text-blue-900 dark:text-white"}>{quiz.title}</h2>
            </div>

            <div className={"flex flex-col gap-4"}>
                <h1 className={"text-preset-1-mobile sm:text-preset-1 leading-preset-1 font-preset-1 text-blue-900 dark:text-white"}>{score}</h1>
